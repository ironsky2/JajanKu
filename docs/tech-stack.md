...
**Versi:** 1.1 (Rumah Dinas Privacy Compliant)
...
### 5.3 Privacy & Anti-Indexing Configuration (Kebijakan Rumah Dinas)
Demi kepatuhan regulasi lingkungan rumah dinas dan menjaga privasi warga, aplikasi ini **TIDAK diindeks oleh mesin pencari publik (Google/Bing)**:

- **Root Layout Metadata (`src/app/layout.tsx`):**
  ```typescript
  export const metadata: Metadata = {
    title: "JajanKuy — Jajan dari Tetangga",
    description: "Katalog masakan & jajan tetangga",
    robots: {
      index: false,
      follow: false,
    },
...
- **File `public/robots.txt`:**
  ...
  Disallow: /
  ```
- **Data Alamat:** Kolom alamat pada database hanya menampung kode blok perumahan sederhana (contoh: *"Blok B No. 3"*), dilarang menyimpan/menampilkan nama instansi atau alamat dinas lengkap.
